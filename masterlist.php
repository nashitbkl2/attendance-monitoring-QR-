            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="./endpoint/add-student.php" method="POST">
                        ...
                        <div class="form-group">
                            <label for="studentCourse">UUCMS:</label>
...
<div class="export-attendance col-4">
                <div class="card">
                    <h5 class="card-header">Export Attendance</h5>
                    <div class="card-body">
                        <form action="./endpoint/export-attendance.php" method="GET">
                        <button class="btn btn-primary" onclick="window.location.href='./endpoint/export-attendance.php'">Download Attendance</button>
